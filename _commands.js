let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `Extreme-bot 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙎𝙐𝙋𝙋𝙊𝙍𝙏\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.com/channel/0029Vaf5BAMLo4hcw3HYv43x\n\n ${Config.botname} *©Tech765™*`;
...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*Extreme-bot CURRENTLY ACTIVE!*";
